...
model ZoneTemperatureControl
  "Temperature control for thermal zone, modulated by pump/fan"
...
info="<html>
<p>
Controller for the zone temperature.
</p>
<p>
This controller adjust the pump/fan speed in order to reduce the speed, unless
