...
model Pump2 "Pump control"
  ...
  Modelica.Blocks.Math.Add x2 "First transition point"
...
equation
  ...
  connect(TMea, lin.u) annotation (Line(points={{-120,-60},{50,-60},{50,0},{58,
          0}}, color={0,0,127}));
  connect(off.y, lin.f2) annotation (Line(points={{21,-40},{40,-40},{40,-8},{58,
          -8}}, color={0,0,127}));
  connect(TSet.y, x1.u2) annotation (Line(points={{-18,0},{-10,0},{-10,14},{-2,
          14}}, color={0,0,127}));
  connect(dTSet.y, x1.u1) annotation (Line(points={{-19,40},{-14,40},{-14,26},{
          -2,26}}, color={0,0,127}));
  connect(TSet.y, x2.u1) annotation (Line(points={{-18,0},{-10,0},{-10,-4},{-2,
          -4}}, color={0,0,127}));
  connect(dTSet.y, x2.u2) annotation (Line(points={{-19,40},{-14,40},{-14,-16},
          {-2,-16}}, color={0,0,127}));
  connect(x1.y, lin.x1)
    annotation (Line(points={{21,20},{30,20},{30,8},{58,8}}, color={0,0,127}));
  connect(on.y, lin.f1)
    annotation (Line(points={{21,60},{40,60},{40,4},{58,4}}, color={0,0,127}));
  connect(x2.y, lin.x2) annotation (Line(points={{21,-10},{30,-10},{30,-4},{58,
          -4}}, color={0,0,127}));
  connect(lin.y, yOut)
