...
partial model PartialSeriesRCZ1 "Partial model for series network"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant THeaWatSupMaxSet[nBui](k=
        bui.THeaWatSup_nominal)
    "Heating water supply temperature set point - Maximum value"
    annotation (Placement(transformation(extent={{-250,210},{-230,230}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TChiWatSupSet[nBui](k=
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiSum ETot(nin=2)
