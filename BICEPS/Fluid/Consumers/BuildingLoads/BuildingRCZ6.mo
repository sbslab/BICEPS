within BICEPS.Fluid.Consumers.BuildingLoads;
model BuildingRCZ6
  ...
  Buildings.Experimental.DHC.Loads.Examples.BaseClasses.GeojsonExportRC.OfficeBuilding.Office
    office annotation (Placement(transformation(extent={{-100,-20},{-80,0}})));
  Buildings.Experimental.DHC.Loads.Examples.BaseClasses.GeojsonExportRC.OfficeBuilding.Floor
    floor annotation (Placement(transformation(extent={{-60,-20},{-40,0}})));
  Buildings.Experimental.DHC.Loads.Examples.BaseClasses.GeojsonExportRC.OfficeBuilding.Storage
    storage annotation (Placement(transformation(extent={{-20,-20},{0,0}})));
  Buildings.Experimental.DHC.Loads.Examples.BaseClasses.GeojsonExportRC.OfficeBuilding.Meeting
    meeting annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  Buildings.Experimental.DHC.Loads.Examples.BaseClasses.GeojsonExportRC.OfficeBuilding.Restroom
    restroom annotation (Placement(transformation(extent={{60,-20},{80,0}})));
  Buildings.Experimental.DHC.Loads.Examples.BaseClasses.GeojsonExportRC.OfficeBuilding.ICT
