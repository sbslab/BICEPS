...
model SimpleRoomOneElement
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    annotation (Placement(transformation(extent={{-16,84},{18,116}}),
...
equation
  ...
  connect(weaBus.TDryBul, eqAirTemp.TDryBul)
    annotation (Line(
    points={{1,100},{0,100},{0,80},{-80,80},{-80,-10},{-26,-10}},
    color={255,204,51},
    thickness=0.5), Text(
    textString="%first",
    index=-1,
  ...
  connect(intGai.y[1], perRad.Q_flow)
    annotation (Line(points={{-39.2,-50},{-30,-50},{-30,-70},{-20,-70}},
                                      color={0,0,127}));
  connect(intGai.y[2], perCon.Q_flow)
    annotation (Line(points={{-39.2,-50},{-30,-50},{-30,-30},{-20,-30}},
                                                            color={0,0,127}));
  connect(intGai.y[3], macConv.Q_flow)
    annotation (Line(points={{-39.2,-50},{-20,-50}},
                                      color={0,0,127}));
  ...
  connect(perRad.port, thermalZoneOneElement.intGainsRad)
    annotation (Line(
    points={{0,-70},{22,-70},{22,-32},{98,-32},{98,24},{92,24}},
    color={191,0,0}));
  ...
  connect(weaBus.TBlaSky, eqAirTemp.TBlaSky)
    annotation (Line(
    points={{1,100},{0,100},{0,80},{-80,80},{-80,-4},{-26,-4}},
    color={255,204,51},
    thickness=0.5), Text(
    textString="%first",
    index=-1,
  ...
  connect(macConv.port, thermalZoneOneElement.intGainsConv)
    annotation (
    Line(points={{0,-50},{20,-50},{20,-30},{96,-30},{96,20},{92,20}},
                                                              color={191,
    0,0}));
  connect(perCon.port, thermalZoneOneElement.intGainsConv)
    annotation (
    Line(points={{0,-30},{96,-30},{96,20},{92,20}},  color={191,0,0}));
  ...
  connect(weaBus, HDirTil[1].weaBus) annotation (Line(
      points={{1,100},{0,100},{0,80},{-80,80},{-80,62},{-68,62}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(weaBus, HDifTil[1].weaBus) annotation (Line(
      points={{1,100},{0,100},{0,80},{-80,80},{-80,30},{-68,30}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(weaBus, HDifTil[2].weaBus) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(port_a, thermalZoneOneElement.ports[1]) annotation (Line(points={{-100,
          -80},{80,-80},{80,-1.95},{81.475,-1.95}}, color={0,127,255}));
  connect(thermalZoneOneElement.TAir, spl.x) annotation (Line(points={{93,32},{96,
          32},{96,60},{60,60},{60,80},{68,80}}, color={0,0,127}));
  connect(spl.y, y)
    annotation (Line(points={{91,80},{110,80}}, color={0,0,127}));
  connect(thermalZoneOneElement.ports[2], port_b) annotation (Line(points={{84.525,
          -1.95},{86,-1.95},{86,-80},{100,-80}}, color={0,127,255}));
