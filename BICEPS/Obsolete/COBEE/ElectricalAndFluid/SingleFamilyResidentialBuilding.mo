within BICEPS.Obsolete.COBEE.ElectricalAndFluid;
model SingleFamilyResidentialBuilding
  ...
  Electrical.Building.Electrical ele(
    ...
    EBatMax=EBatMax,
    PBatMax=PBatMax,
    PBatMin=PBatMin) "Electrical subsystem"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  Fluid.Building.ThermoFluidFourElements mec(
    biomimeticControl=biomimeticControl,
    ...
    TMax=TMax,
    T0=T0,
    tSmo=tSmo) "Mechanical (thermo-fluid) subsystem"
